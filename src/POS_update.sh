...
UPDATE_ID="1Nl_Cf6GhUZrg9sSEkxYHEuqnSqbsz52x"

UPDATE_MD5='88522a862386ee08e3817779501a66f1'

#------------------------------------------------------

KPOS_ID="1Nrj-W84kqIeEbWmyfeqWR2NqsskgCENh"

KPOS_MD5='233ab5cd40d546bff9f112f7ad7654f6'

######################################################
update_314 (){
if [ $VERSION1 -le 1803014 ];then
...
UNTAR=${SUDO}' tar zxf'
NEW_UPDATE_POS_VERSION="1.8.0.30.14.9"
LAST_UPDATE_POS_VERSION=""
NEW_UPDATE_SHELL_VERSION=27
